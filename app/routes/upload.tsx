...
const Upload = () => {
  ...
  const handleAnalyse = async ({
    ...
    if (file) {
      ...
      if (imageFile && imageFile.file) {
        ...
        await kv.set(`resume:${uuid}`, JSON.stringify(data)); // no space after colon!
        ...
        data.feedback = feedbackText; // keep as string, not parsed JSON unless you know the feedback is always a JSON string
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const jobDescription = formData.get('job-desc') as string; // FIX: should be 'job-desc'
